#!/bin/bash
#
# fix extensions dir in the NEW mediawiki container (green stack).
set -eux

NAME="ambivalent_mw_new"

EXTENSIONS="ParserFunctions Loops Variables Scribunto"
...
for EXTENSION in $EXTENSIONS; do
    ...
    echo "Copying new extension ${EXTENSION} from g-mediawiki-new extensions dir ${EXT_DIR}"
