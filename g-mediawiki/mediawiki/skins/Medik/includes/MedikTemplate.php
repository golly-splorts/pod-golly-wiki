...
class MedikTemplate extends BaseTemplate {
	...
	protected function getAside() {
		...
		$html .= Html::rawElement(
            ...
            /* both template and discussion links */
			$this->getPortlet(
				'namespaces',
	 ...
	 * @return string html
	 */
	protected function getPortlet( $name, $content, $msg = null, $setOptions = [], $onlyThisSubkey = null ) {
		...
		if ( is_array( $content ) ) {
			...
			foreach ( $content as $key => $item ) {
                ...
                if ( $onlyThisSubkey === null || $key === $onlyThisSubkey ) {
